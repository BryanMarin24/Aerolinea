...
<html lang="en">
    ...
    <head>
        ...
        <link href="css/ingresosAno.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h2 class="intro-text text-center">AEROLÍNEA UNA |
                            <strong>Reporte de Ingresos por Año</strong>
                        </h2>
                        <hr>
                    </div>
                </div>
        ...
        <script src="js/graficoIngresosAno.js" type="text/javascript"></script>

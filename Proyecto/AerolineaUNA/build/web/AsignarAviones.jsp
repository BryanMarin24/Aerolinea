    ...
    <body>
        ...
        <div class="contenedor">
            <div class="box">
                ...
                <div class="col-sm-12">
                        <form role="form" onsubmit="return false;" id="formAsignarAviones" class="form-horizontal centered">
                            <div class="form-group" id="groupID">
                                <div class="col-sm-4" style="text-align: right; vertical-align: middle;">
                                    <p><b>Buscar por id del avion:</b></p>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="idAvion" placeholder="Digite el id del avión">
                                </div>
                                <div class="col-sm-4">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="identificador">
                    ...
                    <div class="form-group">
                        <label for="tipoAvion" class="col-sm-2 control-label">Tipo de Avión</label>
                        <div class="col-sm-10">

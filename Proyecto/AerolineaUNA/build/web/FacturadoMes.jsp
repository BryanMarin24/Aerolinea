...
<html lang="en">
    ...
    <head>
        ...
        <link href="css/facturadoMes.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
            ...
            <div class="box">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h2 class="intro-text text-center">AEROLÍNEA UNA |
                            <strong>Reporte de Montos Facturados por Mes</strong>
                        </h2>
                        <hr>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div id="canvas-holder" class="col-lg-12"  >
                        ...
                        <canvas class="col-md-10" id="grafico"></canvas>
                        <div class="col-md-1"></div>
                    </div>
                </div>
        ...
        <script src="js/graficoFacturadoMes.js" type="text/javascript"></script>

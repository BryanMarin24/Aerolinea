                ...
                <form role="form" onsubmit="return false;" class="form-horizontal" id="formAviones">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="groupCantFilas">
                            <input type="number" class="form-control" name="quantity" id="cantFilas" min="1" max="40">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"id="groupCantAsientosFila">
                            <input type="number" class="form-control" name="quantity" id="cantAsientosFila" min="6" max="9">
                        </div>
                    </div>

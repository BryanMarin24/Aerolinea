...
function eliminarRuta(idRuta) {
   $("#myModalTitle").html("Eliminar Ruta");
     $("#myModalMessage").html("Esta Seguro que desea Eliminar ruta "+idRuta+" ?");
      $("#myModalFooter").html('<button class="btn btn-primary" onclick="eliminar('+"'"+idRuta+"'"+');">Aceptar</button>'+
